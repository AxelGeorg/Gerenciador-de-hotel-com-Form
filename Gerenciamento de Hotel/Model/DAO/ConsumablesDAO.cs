...
namespace Gerenciamento_de_Hotel.Model.DAO
{
    class ConsumablesDAO
    {
        ...
        /// <summary>
        /// Retorna uma lista de consumíveis de acordo com o tipo do produto.
        /// </summary>
        /// <param name="tipoOrdenacao"></param>
        /// <returns></returns>
        public List<Consumables> BuscarConsumablesPorTipoProduto(int tipoOrdenacao, string tipoProduto)
        {
            try
            {
                var listConsumables = new List<Consumables>();
